...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>A scale going from black (0) to white (255) with number values marked in between.</p></figcaption></figure>
